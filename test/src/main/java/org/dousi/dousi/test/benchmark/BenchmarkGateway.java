package org.dousi.dousi.test.benchmark;

import org.dousi.dousi.test.common.BenchmarkIService;
...
public class BenchmarkGateway {
  ...
  public void start(BenchmarkIService service) {
    ServerBootstrap bootstrap = new ServerBootstrap();
    bossGroup = new NioEventLoopGroup(1);
    workerGroup = new NioEventLoopGroup(Runtime.getRuntime().availableProcessors() * 2);
    ChannelHandler handler = new HttpProcessHandler(service);
