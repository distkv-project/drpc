...
import org.drpc.api.DefaultResponse;
import org.drpc.api.ProtobufRequestDelegate;
import org.drpc.api.ProtobufResponseDelegate;
...
public class DrpcCodec implements Codec {
  ...
  @Override
  public byte[] encode(Object message) throws DrpcCodecException {
  ...
  @Override
  public Object decode(byte[] data, DataTypeEnum dataTypeEnum) throws DrpcCodecException {
    try {
      ...
      throw new DrpcCodecException("Illegal DataTypeEnum: " + dataTypeEnum);
    } catch (Exception e) {
      throw new DrpcCodecException("Decode error", e);
    }
  }
}
