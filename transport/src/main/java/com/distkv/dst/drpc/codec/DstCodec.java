...
import com.distkv.dst.drpc.constants.CodecConstants;
import com.distkv.dst.drpc.constants.CodecConstants.DataType;
import com.distkv.dst.drpc.constants.CodecConstants.Version;
import com.distkv.dst.drpc.exception.CodecException;
import com.distkv.dst.drpc.utils.ReflectUtils;
  ...
  public Object decode(byte[] data) throws CodecException {
    ...
    try {
      switch (DataType.getDataTypeByValue(dataType)) {
        case NONE:
          return com.distkv.dst.drpc.common.Void.getInstance();
        case REQUEST:
